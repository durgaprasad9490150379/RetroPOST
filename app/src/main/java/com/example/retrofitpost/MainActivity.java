...
public class MainActivity extends AppCompatActivity {
    ...
    private ApiInterface ApiInterfaceObject1;
    ...
    private void createPost() {
        ...
        Call<Object> call_img = ApiInterfaceObject.createPostImage( token, img_user);
        ...
        call_img.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                if (!response.isSuccessful()) {
                    textViewResult2.setText("Success "+response.toString());
                    return;
                }else{

                    textViewResult2.setText("In onResponse" + response.body());
                }
            ...
            public void onFailure(Call<Object> call, Throwable t) {
                textViewResult2.setText("Failure " + t.toString());
            }
        });
