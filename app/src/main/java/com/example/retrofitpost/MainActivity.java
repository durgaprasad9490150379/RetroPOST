...
//        ContextWrapper cw = new ContextWrapper(this.MainActivity);
...
//        File mypath=new File(directory,"imagename.jpg");
        ...
        File file  = new File("/mnt/sdcard/visitor1.jpg");
        ...
        Call<Object> call_img = ApiInterfaceObject.uploadImagePost(
                token,
                fileToUpload
//                fileMeta
        );
        ...
        call_img.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                if (!response.isSuccessful()) {
                    ...
                    textViewResult2.setText("" + response.body());
                }
